...
const CartIcon = () => {
  ...
  return (
    <div className="bg-secondary_color items-center justify-center flex relative p-4 rounded-md duration-300 transition ease-in-out font-rubik hover:cursor-pointer hover:scale-105">
